...
export default function NavbarStyle1() {
  return (
    <nav className="flex items-center justify-between px-10 py-3 bg-white/70 backdrop-blur-sm sticky top-5 z-50 shadow-[0_2px_2px_#CAEBFF] rounded-[24px] w-[96%] max-w-7xl mx-auto">
